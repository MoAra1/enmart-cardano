      ...
      <div className="ray__block mb-3">
        <div className={style.menu}>
          ...
          <span className="ms-auto me-3 d-none d-sm-inline">
            ...
            >
              <span className="pe-2">ENFTR</span>
        ...
        <div className="mb-5">
                ...
                <div className={`${style.footerLists} row`}>
                  ...
                  >
                    {/* <div className="d-flex mb-4">
                      ...
                      <h6 className="mb-0">ENMart is the flagship NFT mark</h6>
                    </div> */}
                    ...
                    <div className="row">
                      <div className="col-6 col-sm-12">
                        <div className="d-flex mb-4">
                          ...
                          <h6 className="mb-0">ENFTR</h6>
                        </div>
                        <ul className="list-unstyled mb-5">
                          <li>
                            <a
                              href="https://twitter.com/enftrafrica"
                              className="text-muted"
                            >
                              Twitter
                            </a>
                          ...
                          <li>
                            <a
                              href="https://t.me/Enversemetaverse"
                              className="text-muted"
                            >
                              Telegram
                            </a>
                      ...
                      <div className="col-6 col-sm-12">
                        <div className="d-flex mb-4">
                          ...
                          <h6 className="mb-0">enmart.enftr.io</h6>
                        </div>
                        <ul className="list-unstyled mb-4">
                          <li>
                            <a
          ...
          <div className="col-12 col-md-6">
            <p className="mb-2 text-muted">
              Advanced ENVerse Ecosystem on the Cardano Blockchain Platform
            </p>
            <p className="mb-0 text-muted">
              {new Date().getFullYear()} &copy; ENMart
            </p>
          </div>
        </div>
      </div>
